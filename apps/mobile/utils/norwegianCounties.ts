...
export const NORWEGIAN_COUNTIES = [
  ...
  { name: 'Akershus', lat: 59.95, lng: 11.0 },
  { name: 'Buskerud', lat: 60.0, lng: 9.5 },
  ...
  { name: 'Telemark', lat: 59.3, lng: 9.0 },
  { name: 'Troms', lat: 69.4, lng: 19.0 },
  { name: 'Trøndelag', lat: 63.43, lng: 10.4 },
  { name: 'Vestfold', lat: 59.3, lng: 10.3 },
  { name: 'Vestland', lat: 60.8, lng: 6.0 },
  { name: 'Østfold', lat: 59.3, lng: 11.2 },
